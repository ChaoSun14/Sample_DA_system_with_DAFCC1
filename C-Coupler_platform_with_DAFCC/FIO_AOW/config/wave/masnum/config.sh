...
link_data "$DATA_SRC_DIR/demo/topo/DEMO_topo.nc" "$DATA_DST_DIR/input_data/"
#link_data "$DATA_SRC_DIR/West_pacific/realtime/$start_year$start_month$start_day$start_hour/wind/wind$start_year$start_month$start_day$start_hour.nc" "$DATA_DST_DIR/input_data/"
...
INTERVAL_OUT = 1
! units is hou 
INTERVAL_RESTART = 720
#OUT_DATA_NAME = ctime bv windx windy hs tp tz th
OUT_DATA_FIG =  T T T T T T T T T T T T T T T                         

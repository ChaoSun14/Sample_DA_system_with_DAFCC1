module gsi_ccpl_grid_vars_mod
    ...
    use gsi_ccpl_kinds, only: gsi_grid_instance_id, gsi_grid_id_input, gsi_comp_id, gsi_grid_id, gsi_vert_grid1, gsi_vert_grid2, gsi_3d_grid1, gsi_3d_grid2, gsi_regional_time_grid_id, gsi_global_decomp_id
    use gsi_ccpl_kinds, only: ccpl_nlon_regional, ccpl_nlat_regional, ccpl_nsig, ccpl_nsig_soil, ccpl_pt, ccpl_aeta1, ccpl_eta1, ccpl_aeta2, ccpl_eta2, ccpl_glat, ccpl_glon, ccpl_dx_mc, ccpl_dy_mc  
